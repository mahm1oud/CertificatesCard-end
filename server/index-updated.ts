...
const allowedOrigins = (process.env.ALLOWED_ORIGINS || 'http://localhost:5000,http://localhost:3000,http://localhost:5173,https://collider.online:5000,https://collider.online').split(',');
